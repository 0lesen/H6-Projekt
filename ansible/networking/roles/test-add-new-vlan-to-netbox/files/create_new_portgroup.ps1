...
$createNewVlanTag = "create_new_cluster_vlan"


$getClusterVlansDetails = (Invoke-RestMethod -SkipCertificateCheck -Uri $api_base_url/ipam/vlans/?tag=$($createNewVlanTag) -Headers $headers).results
