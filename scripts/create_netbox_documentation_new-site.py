...
new_site_name_input = str(input("Site by (AAR): "))
new_site_id_input = str(input("Site ID (01): "))
core_id = str(input("Core device ID from Netbox: "))
core_interface_id = str(input("Next available interface ID from Netbox: "))
